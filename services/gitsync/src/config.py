...
class Config():
    ...
    # karma repo
    GITHUB_KARMA_DATA_OWNER = os.getenv("GITHUB_KARMA_DATA_OWNER")
    GITHUB_KARMA_DATA_REPO = os.getenv("GITHUB_KARMA_DATA_REPO")
    GITHUB_KARMA_DATA_CERT_FILENAME = os.getenv("GITHUB_KARMA_DATA_CERT_FILENAME")
